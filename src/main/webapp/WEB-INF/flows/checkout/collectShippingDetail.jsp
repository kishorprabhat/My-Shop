...
<div class="container-wrapper">
	...
	<div class="container">
		...
		<div class="form-layout">
			<form:form method="post" commandName="order" class="form-horizontal">
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
						...
						<form:input path="cart.customer.shippingAddress.strretName"
							id="shippingAddress.strretName" class="form-control"
							disabled="true" />
					</div>
				</div>
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
						<form:input path="cart.customer.shippingAddress.city"
							id="shippingCity" class="form-control" disabled="true" />
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
						...
						<form:input path="cart.customer.shippingAddress.state"
							id="shippingAddress.state" class="form-control" disabled="true" />
					</div>
				</div>
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
						...
						<form:input path="cart.customer.shippingAddress.country"
							id="shippingCountry" class="form-control" disabled="true" />
					</div>
				</div>
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
						...
						<form:input path="cart.customer.shippingAddress.zipCode"
							id="shippingZipCode" class="form-control" disabled="true" />
					</div>
				</div>
