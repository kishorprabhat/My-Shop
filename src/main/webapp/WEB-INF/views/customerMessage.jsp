...
<c:url var="prevUrl"
	value="/admin/customerMessages/${currentPageNumber - 1}" />
<c:url var="nextUrl"
	value="/admin/customerMessages/${currentPageNumber + 1}" />
			...
			<div class="container">
				...
				<c:forEach var="contact" items="${customerContacts}">
					...
					<div class="row message">
						...
						<div class="row"
							style="margin-bottom: 20px; margin-left: -3px; color: crimson;">

							<div class="col-md-6">UserName
								:${contact.customer.customerName}</div>


							<div class="col-md-6">Date : ${contact.date}</div>
						...
						<form
							action="<c:url value="/admin/customerMessages/deleteMessage" />"
							method="post" class="form-horizontal">


							<input type="hidden" name="customerMessageId"
								value="${contact.contactId}"> <input type="hidden"
								name="currentPageNumber" value="${currentPageNumber}"> <input
								type="hidden" name="${_csrf.parameterName}"
								value="${_csrf.token}" /> <input type="submit"
								value="Delete Message" class="btn btn-danger operation">
						</form>
