<form:form commandName="order" class="form-horizontal">
	...
	<div class="form-group">
		...
		<form:input path="cart.customer.shippingAddress.strretName"
			id="shippingStreet" class="form-control" disabled="true" />
	</div>

	<div class="form-group">
		<label for="shippingApartmentNumber">Apartment Number</label>
		<form:input path="cart.customer.shippingAddress.apartmentNumber"
			id="shippingApartmentNumber" class="form-control" disabled="true" />
	</div>
	...
	<div class="form-group">
		...
		<form:input path="cart.customer.shippingAddress.state"
			id="shippingState" class="form-control" disabled="true" />
	</div>
