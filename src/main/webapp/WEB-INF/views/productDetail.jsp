		...
		<div class="container" ng-app="cartApp">
			<div class="row">
				...
				<div class="col-md-5 product-details">
					<p>
						<strong class="desc-title col-md-4">Name </strong>:
						${product.productName}
					</p>
					<p>
						<strong class="desc-title col-md-4">Description </strong>
						:${product.productDescription}
					</p>
					<p>
						<strong class="desc-title col-md-4">Model</strong>:
						${product.productModel}
					</p>
					<p>
						<strong class="desc-title col-md-4">Category</strong>:
						${product.productCategory}
					</p>
					<p>
						<strong class="desc-title col-md-4">Condition</strong>:
						${product.productStatus}
					</p>
					<p>
						<strong class="desc-title col-md-4">Price:</strong> :
					...
					<c:set var="url" scope="page"
						value="/product/productList/${product.productCategory}/1" />
