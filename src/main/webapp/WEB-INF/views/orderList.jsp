			...
			<c:forEach items="${orders}" var="order">
				<tr>
					...
					<td><a class="btn btn-info"
						href=" <spring:url value="/admin/customerOrder/productList/${order.customerOrderId}"/>">See
							Receipt</a></td>
					<td><a class="btn btn-danger"
						href=" <spring:url value="/admin/customerOrder/deletOrder/${order.customerOrderId}"/>">Clear
							Order</a></td>
